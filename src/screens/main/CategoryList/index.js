...
import { View, Text, Image, FlatList, TextInput, TouchableOpacity, ScrollView, Dimensions, StatusBar, ImageBackground,Platform } from "react-native";
    ...
    <View style={{ flex: 1,}}>
      ...
      <View style={styles.main}>
        <View style={styles.go}>
          ...
          {click?null:<Text style={styles.cake}>Cakes</Text>}
        </View>
        ...
        <View style={styles.mod}>
          ...
          <View style={{ paddingVertical: 30, paddingHorizontal: 25 }}>
            ...
            {cake ?
              ...
              : <View />}
            <View style={[styles.cmn, { marginTop: 4 }]}>
