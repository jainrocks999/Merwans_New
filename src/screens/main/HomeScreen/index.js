...
const HomeScreen = ({route}) => {
  ...
  useEffect(async () => {
    ...
    try {
      ...
      data1.append(
        'key',
        '',
      );
  ...
  return (
    <View style={{flex: 1}}>
      ...
      <ScrollView
        ...
        <TouchableOpacity
          ...
          <Text style={styles.location}>
            {location ? location : 'Select Store'}
          </Text>
        </TouchableOpacity>
        {selector1.banner == true ? (
          ...
          <View style={{}}>
            ...
            <View style={{paddingHorizontal: 12, marginTop: -449}}>
              <View style={styles.row}>
                <TouchableOpacity
                  onPress={() =>
                    manageList(selector1.deliverCategory[0].category_id)
                  }
                  style={styles.main}>
                  <Image
                    style={styles.image}
                  ...
                  <Text
                    ...
                    {selector1.deliverCategory[0].name}
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() =>
                    manageList(selector1.deliverCategory[1].category_id)
                  }
                  style={styles.main}>
                  <Image
                    style={styles.image}
                  ...
                  <Text
                    ...
                    {selector1.deliverCategory[1].name}
                  </Text>
                </TouchableOpacity>
              </View>
              <View style={[styles.row, {marginTop: 12}]}>
                <TouchableOpacity
                  ...
                  <Text
                    ...
                    {selector1.deliverCategory[2].name}
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() =>
                    manageList(selector1.deliverCategory[3].category_id)
                  }
                  style={styles.main}>
                  <Image
                    style={styles.image}
                  ...
                  <Text
                    ...
                    {selector1.deliverCategory[3].name}
                  </Text>
                </TouchableOpacity>
              </View>
            </View>
        ...
        <View
          ...
          selector1.specialCategoryData[0].products ? (
            <View style={styles.cont}>
              ...
              <TouchableOpacity
                onPress={() =>
                  manageList(selector1.specialCategoryData[0].category_id)
                }
          ...
          selector1.specialCategoryData[0].products ? (
            <View style={[styles.row1, {marginBottom: 30}]}>
              <TouchableOpacity
                onPress={() =>
                  manageListIem(
                    selector1.specialCategoryData[0].category_id,
                    selector1.specialCategoryData[0].products[0].product_id,
                  )
                }
                style={styles.view}>
                <Image
                ...
                <View style={styles.view2}>
                  <Text style={styles.cake}>
                    {selector1.specialCategoryData[0].products[0].name}
                  </Text>
                  <Text style={styles.des}>
                    {selector1.specialCategoryData[0].products[0].description}
                  </Text>
                  <View style={styles.rView}>
                    <Text style={styles.rupees}>{`₹${parseInt(
                      selector1.specialCategoryData[0].products[0].price,
                    ).toFixed(2)}`}</Text>
                  </View>
                </View>
              </TouchableOpacity>
              <TouchableOpacity
                onPress={() =>
                  manageListIem(
                    selector1.specialCategoryData[0].category_id,
                    selector1.specialCategoryData[0].products[1].product_id,
                  )
                }
                style={styles.view}>
                <Image
                ...
                <View style={styles.view2}>
                  <Text style={styles.cake}>
                    {selector1.specialCategoryData[0].products[1].name}
                  </Text>
                  <Text style={styles.des}>
                    {selector1.specialCategoryData[0].products[1].description}
                  </Text>
                  <View style={styles.rView}>
                    <Text style={styles.rupees}>{`₹${parseInt(
                      selector1.specialCategoryData[0].products[1].price,
                    ).toFixed(2)}`}</Text>
                  </View>
                </View>
              </TouchableOpacity>
          ...
          {selector1.trendingProduct == true ? (
      ...
      <View>
        <BottomTab home={true} search={false} cart={false} profile={false} />
      </View>
