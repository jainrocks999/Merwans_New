  ...
  const renderHome = () => {
    return (
      <View style={styles.container}>
        <View
          style={{
            backgroundColor: home == true ? '#808080' : '#232323',
            borderRadius: 20,
            padding: 3,
          }}>
  ...
  const renderBank = () => {
    return (
      <View style={styles.container}>
        <View
          style={{
            backgroundColor: search == true ? '#808080' : '#232323',
            borderRadius: 20,
            padding: 6,
          }}>
  ...
  const renderKnowledge = () => {
    return (
      <View style={styles.container}>
        <View
          style={{
            backgroundColor: cart == true ? '#808080' : '#232323',
            borderRadius: 20,
            padding: 6,
          }}>
        ...
        {data1 && data1.products ? (
          data1.products.length > 0 ? (
            <View
              ...
              <Text style={{fontSize: 10, color: '#ED1B1A', marginBottom: 1}}>
                {data1.products.length}
              </Text>
            </View>
          ) : null
        ) : null}
  ...
  const renderTrending = () => {
    return (
      <View style={styles.container}>
        <View
          style={{
            backgroundColor: profile == true ? '#808080' : '#232323',
            borderRadius: 20,
            padding: 3,
          }}>
